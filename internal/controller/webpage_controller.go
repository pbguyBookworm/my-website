...
// +kubebuilder:rbac:groups=web.mywebsite.com,resources=webpages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=web.mywebsite.com,resources=webpages/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=web.mywebsite.com,resources=webpages/finalizers,verbs=update
