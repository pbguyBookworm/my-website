...
type WebpageSpec struct {
	...
	// Bar is a string pointer field for Webpage
	// +optional
...
type Webpage struct {
	...
	// spec defines the desired state of Webpage
	// +required
	Spec WebpageSpec `json:"spec"`

	// status defines the observed state of Webpage
	// +optional
	Status WebpageStatus `json:"status,omitempty,omitzero"`
}
